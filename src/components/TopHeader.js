...
const TopHeader = () => {
  return (
    <div className="bg-brand-darker text-gray-400 text-[11px] uppercase tracking-widest py-2 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-2">
